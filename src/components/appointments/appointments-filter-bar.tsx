...
import { AppointmentsActiveFilters } from "@/components/appointments/appointments-active-filters"
import { AppointmentsMoreFilters } from "@/components/appointments/appointments-more-filters"
...
import type { ActiveAppointmentFilter } from "@/lib/appointments/build-appointments-filter"
...
type AppointmentsFilterBarProps = {
  ...
  status: string
  stylistId: string
  activeFilters: ActiveAppointmentFilter[]
...
export function AppointmentsFilterBar({
  ...
  return (
    <div className="bg-card flex flex-col gap-3 rounded-lg border p-3 sm:p-4">
      {/* Row 1 — search dominant (users module pattern) */}
      <form
        onSubmit={submit}
      ...
      <AppointmentsActiveFilters
        filters={activeFilters}
        onClearFilter={onClearFilter}
        onClearAll={onClearAllFilters}
      />

      <AppointmentsMoreFilters
